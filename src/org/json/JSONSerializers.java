...
public class JSONSerializers {
	...
	public static class JSONParamSerializer implements JsonSerializer<JSONParam>{

		@Override
		public JsonElement serialize(JSONParam src, Type srcType,
				JsonSerializationContext context){
			JsonObject obj = new JsonObject();
			if(src.getValue() instanceof String){
				obj.addProperty(src.getName(), (String)src.getValue());
			}
			else if(src.getValue() instanceof Number){
				obj.addProperty(src.getName(), (Number)src.getValue());
			}
			return obj;
		}
	}
