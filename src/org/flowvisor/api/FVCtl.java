 ...
 *
 * This is pretty hack and just for testing; people should write their own
 * clients and/or call the XMLRPC directly
 * 
 * Contains the commands invoked using this simple XMLPRC client. The declaration 
 * and implementation of these commands is at FVUserAPI.java & FVUserAPIImpl.java
 * 
 * @author capveg
 * @author tasos.vlachogiannis@bristol.ac.uk
 * 
 */
public class FVCtl {
	String URL;
	...
	static APICmd[] cmdlist = new APICmd[] {
		...
		new APICmd("listCDevices", 0),
		new APICmd("listAllDevices", 0),
		new APICmd("getDeviceInfo", 1, "<dpid>"),
		new APICmd("getLinks", 0),
		new APICmd("getCLinks", 0),
		...
		new APICmd("unregisterTopologyChangeCallback", 0),
	...
	public void run_listCDevices() throws XmlRpcException {
		Object[] reply = (Object[]) this.client.execute("api.listCDevices",
				new Object[] {});
		if (reply == null) {
			System.err.println("Got 'null' for reply :-(");
			System.exit(-1);
	...
	public void run_listAllDevices() throws XmlRpcException {
		Object[] reply = (Object[]) this.client.execute("api.listAllDevices",
				new Object[] {});
		if (reply == null) {
			System.err.println("Got 'null' for reply :-(");
			System.exit(-1);
	...
	@SuppressWarnings("unchecked")
	public void run_getCLinks() throws XmlRpcException, MapUnparsable {
		Object[] reply = (Object[]) this.client.execute("api.getCLinks",
				new Object[] {});
		if (reply == null) {
			System.err.println("Got 'null' for reply :-(");
			System.exit(-1);
