...
public interface FVUserAPI {
	 ...
	 * the FV - only for the packet domain
	 *
	 * @return
	 */
	...
	/**
	 * Get the list of device DPIDs (e.g., switches, routers, APs) connected to
	 * the FV- optical domain
	 *
	 * @return
	 */
	public Collection<String> listCDevices();

	/**
	 * Get the list of all device DPIDs (e.g., switches, routers, APs) connected to
	 * the FV
	 *
	 * @return
	 */
