...
public class TopologyCallback implements Runnable {
	...
	XmlRpcClient client;
	ArrayList<Collection<JSONParam>> queuedParams = new ArrayList<Collection<JSONParam>>();
	...
	public static final Gson gson =
		...
		.registerTypeAdapter(FlowEntry.class, new JSONDeserializers.FlowEntryDeserializer())
		.registerTypeAdapter(JSONParam.class, new JSONSerializers.JSONParamSerializer())
		.create();
	...
	private void runSpecificCallback(){
		...
		try {
			JSONRequest jsonReq = new JSONRequest(this.methodName, queuedParams.remove(0), nextId());
			...
			FVLog.log(LogLevel.INFO, null, "Sending json: " + gson.toJson(jsonReq));
