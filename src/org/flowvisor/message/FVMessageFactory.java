...
public class FVMessageFactory extends BasicFactory {
	...
	static final Class convertMap[] = {FVHello.class, FVError.class,
			...
			FVBarrierReply.class, FVCFlowMod.class, FVCPortStatus.class };
	...
	public OFMessage getMessage(OFType t) {
		...
		if (t == null)
		{
			//System.out.println("aaaaaaa inside FV message Factory - unknown message ");
			return new FVUnknownMessage();
		}
		byte mtype = t.getTypeValue();
		// ali-test //
		if (mtype==22) mtype=20;
		if (mtype==255) mtype=20;
		if (mtype==254) mtype=21;
		
		if(mtype==-2) mtype=21;
		
		System.out.println("aaaaaaaaaaa type: "+mtype);
		//if (mtype==-1) mtype=21;
	...
	public OFAction getAction(OFActionType t) {
		//ali-test//
		//System.out.println("aaaaaaaaa action type: "+t.getTypeValue());
		//System.out.println();
